...
hip_data <- read.csv('plotting_data 3.csv')
```
  ...
  mutate(
    ...
    ind_7a = case_when(
      wdest %in% c(
        ...
        "Short term care in residential care facility (New Zealand only)"
      ) ~ TRUE,
      wdest %in% c(
...
```{r include=FALSE, echo = FALSE}
data_2023 <- data_raw %>% filter(tarrdatetime_year<2024 | arrdatetime_year<2024 |admdatetimeop_year<2024)

alive_not_discharged <- data_2023 %>%
  filter(mort365d  != 2 & (tarrdatetime_year>2022 | arrdatetime_year>2022 |admdatetimeop_year>2022) & is.na(hdisch_year))

patients_2023 <- data_raw %>%
  filter(tarrdatetime_year==2023 | arrdatetime_year==2023 |admdatetimeop_year==2023)
```


<h2><span style="color:#423A8E">National Snapshot</span></h2>
...
<div class="kpi-cards">
  ...
  <div class="kpi-card" style="background-color:#5296D5;">
   2023 Records <br>`r nrow(patients_2023)`
  </div>

  <div class="kpi-card" style="background-color:#58B99D;">
   All Records <br>`r nrow(data_2023)`
  </div>
</div>
...
hospitals  = n_distinct(ahos_code),
...
<div class="dem-button" style="grid-template-columns: repeat(3, minmax(220px, 1fr));">
  <div class="dem-button__item">Hospitals: `r overview_tbl$hospitals`</div>
...
```{r, echo=FALSE}
p1a <- prop_for_donut(hip_data, "ind_1a")
p1a_ach <- round(p1a$prop[p1a$status == "Achieved"]*100, digits = 2)  # this is 0–1

p2a <- prop_for_donut(hip_data, "ind_2a")
p2a_ach <- round(p2a$prop[p2a$status == "Achieved"]*100, digits = 2)  # this is 0–1
p2b <- prop_for_donut(hip_data, "ind_2b")
p2b_ach <- round(p2b$prop[p2b$status == "Achieved"]*100, digits = 2)  # this is 0–1
p2c <- prop_for_donut(hip_data, "ind_2c")
p2c_ach <- round(p2c$prop[p2c$status == "Achieved"]*100, digits = 2)  # this is 0–1

p3a <- prop_for_donut(hip_data, "ind_3a")
p3a_ach <- round(p3a$prop[p2a$status == "Achieved"]*100, digits = 2)  # this is 0–1
p3b <- prop_for_donut(hip_data, "ind_3b")
p3b_ach <- round(p3b$prop[p3b$status == "Achieved"]*100, digits = 2)  # this is 0–1
p3c <- prop_for_donut(hip_data, "ind_3c")
p3c_ach <- round(p3c$prop[p3c$status == "Achieved"]*100, digits = 2)  # this is 0–1

p4a <- prop_for_donut(hip_data, "ind_4a")
p4a_ach <- round(p4a$prop[p4a$status == "Achieved"]*100, digits = 2)  # this is 0–1

p5a <- prop_for_donut(hip_data, "ind_5a")
p5a_ach <- round(p5a$prop[p5a$status == "Achieved"]*100, digits = 2)  # this is 0–1
p5b <- prop_for_donut(hip_data, "ind_5b")
p5b_ach <- round(p5b$prop[p5b$status == "Achieved"]*100, digits = 2)  # this is 0–1

p6a <- prop_for_donut(hip_data, "ind_6a")
p6a_ach <- round(p6a$prop[p6a$status == "Achieved"]*100, digits = 2)  # this is 0–1

p7a <- prop_for_donut(hip_data, "ind_7a")
p7a_ach <- round(p7a$prop[p7a$status == "Achieved"]*100, digits = 2)  # this is 0–1
```
...
<div class="page-button">
  <div class="page-button__item">
    <a href="#qs-1" class="page-button__link">
      ...
      <div class="page-button__body"><p style="color: red; font-size: 30px;"> `r p1a_ach` % </p></div> 
      <img src="images/qs1.png" style="display:block;float:left;width:50px;height:50px;">
    </a>
  </div>
  ...
  <div class="page-button__item">
    <a href="#qs-2" class="page-button__link">
      ...
      <div class="page-button__body"><p style="color: red; font-size: 30px;"> `r p2a_ach` % </p></div>
      <div class="page-button__body">Indicator 2b: Nerve block prior to surgery Indicator</div>
      <div class="page-button__body"><p style="color: red; font-size: 30px;"> `r p2b_ach` % </p></div>
      <div class="page-button__body">Indicator 2c: Nerve block prior to transfer (transfer patients)</div>
      <div class="page-button__body"> <p style="color: red; font-size: 30px;">`r p2c_ach` % </p></div>
      <img src="images/qs2.png" style="display:block;float:left;width:50px;height:50px;">
    </a>
  </div>
  ...
  <div class="page-button__item">
    <a href="#qs-3" class="page-button__link">
      ...
      <div class="page-button__body"> <p style="color: red; font-size: 30px;">`r p3a_ach` % </p></div>
      <div class="page-button__body">Indicator 3b: Delirium assessment after surgery</div>
      <div class="page-button__body"><p style="color: red; font-size: 30px;"> `r p3b_ach` % </p></div>
      <div class="page-button__body">Indicator 3c: Received Protein and energy oral nutritional supplements</div>
      <div class="page-button__body"> <p style="color: red; font-size: 30px;">`r p3c_ach` % </p></div>
      <img src="images/qs3.png" style="display:block;float:left;width:50px;height:50px;">
    </a>
  </div>
  ...
  <div class="page-button__item">
    <a href="#qs-4" class="page-button__link">
      ...
      <div class="page-button__body"> <p style="color: red; font-size: 30px;">`r p4a_ach` % </p></div>
      <img src="images/qs4.png" style="display:block;float:left;width:50px;height:50px;">
    </a>
  </div>
</div>
...
<div class="page-button page-button--three">
  <div class="page-button__item">
    <a href="#qs-5" class="page-button__link">
      ...
      <div class="page-button__body"> <p style="color: red; font-size: 30px;">`r p5a_ach` % </p></div>
      <div class="page-button__body">Indicator 5b: Did not develop new Stage-II-or-higher pressure injury</div>
      <div class="page-button__body"> <p style="color: red; font-size: 30px;">`r p5b_ach` % </p></div>
      <img src="images/qs5.png" style="display:block;float:left;width:50px;height:50px;">
    </a>
  </div>
  ...
  <div class="page-button__item">
    <a href="#qs-6" class="page-button__link">
      ...
      <div class="page-button__body"> <p style="color: red; font-size: 30px;">`r p6a_ach` % </p></div>
      <img src="images/qs6.png" style="display:block;float:left;width:50px;height:50px;">
    </a>
  </div>
  ...
  <div class="page-button__item">
    <a href="#qs-7" class="page-button__link">
      ...
      <div class="page-button__body"> <p style="color: red; font-size: 30px;">`r p7a_ach` % </p></div>
      <img src="images/qs7.png" style="display:block;float:left;width:50px;height:50px;">
    </a>
  </div>
</div>
```
...
# Quality Standard 1 {#qs-1 scrolling="true"}
